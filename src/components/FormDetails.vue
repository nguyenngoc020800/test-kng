<template>
    <form action="" @submit.prevent="submit" class="p-3 row w-100" >
        ...
        <div class="notification" v-if="notification">
            <div class="content">
                <h2 class="py-3">CẬP NHẬT THÔNG TIN THÀNH CÔNG!</h2>
                <button class="btn btn-primary w-50" @click.prevent="updateSuccess">xác nhận</button>
            </div>
        </div>
        <!-- thông báo  -->
        <div class="col-12 col-sm-6">
            ...
            <div class="button d-flex justify-content-end py-3">
                <button class="btn btn-success mx-2 w-25">update</button>
                <button class="btn btn-outline-primary mx-2 w-25" @click.prevent="this.$router.push(`/list`)">Cancel</button>
...
export default {
    ...
    data: function(){
            return {
                ...
                form:{
                    ...
                    payMode: this.user?.payMode,
                    expination: this.user?.expination,
                    cvn: this.user?.cvn,
                    donate: this.user?.donate,
                    id:this.user?.id
                } ,
                notification:false
            }
    ...
    methods: {
        ...
        submit() {
            ...
            this.validation10()&&
            this.validation11()) {
                // gán giá trị cho this.user trong store
                this.updateUser(this.$data.form)
                this.notification = true
            }
        },
        // xác nhận hoàn thành update
        updateSuccess() {
